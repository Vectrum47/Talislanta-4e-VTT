...
export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("talislanta", "macroShorthand");
  ...
  static async createDialog(data={}, options={}) {
    ...
    const templates = collection.filter(a => a.getFlag("talislanta", "isTemplate"));
    ...
    return Dialog.prompt({
      ...
      callback: html => {
        ...
        if ( template ) {
          ...
          delete createData.flags.talislanta.isTemplate;
        }
